    ...
    <section className="bg-gray-900 text-white h-screen flex items-center">
      <div className="grid px-6 mx-auto max-w-screen-xl lg:gap-10 xl:gap-12 lg:grid-cols-12">
        <div className="place-self-center mr-auto lg:col-span-7">
          <h1 className="mb-6 max-w-2xl text-5xl font-extrabold leading-tight md:text-6xl xl:text-7xl shadow-md">
            One Gallery
          </h1>
          <p className="mb-8 max-w-2xl font-light text-gray-400 lg:mb-10 md:text-lg lg:text-xl">
            Discover and share your favorite images with our platform, a place
            where creativity meets community. Upload your images and explore
            content from users around the world.
          </p>
